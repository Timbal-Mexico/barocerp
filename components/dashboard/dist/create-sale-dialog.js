...
exports.CreateSaleDialog = void 0;
...
function CreateSaleDialog(_a) {
    ...
    var _d = react_1.useState([]), warehouses = _d[0], setWarehouses = _d[1];
    var _e = react_1.useState(''), selectedLead = _e[0], setSelectedLead = _e[1];
    var _f = react_1.useState('facebook'), channel = _f[0], setChannel = _f[1];
    var _g = react_1.useState(''), marketingChannel = _g[0], setMarketingChannel = _g[1];
    var _h = react_1.useState(''), selectedWarehouse = _h[0], setSelectedWarehouse = _h[1];
    var _j = react_1.useState(''), deliveryCity = _j[0], setDeliveryCity = _j[1];
    var _k = react_1.useState(''), agentName = _k[0], setAgentName = _k[1];
    var _l = react_1.useState(''), saleDate = _l[0], setSaleDate = _l[1]; // YYYY-MM-DDTHH:mm
    var _m = react_1.useState([]), items = _m[0], setItems = _m[1];
    var _o = react_1.useState(false), loading = _o[0], setLoading = _o[1];
    var _p = react_1.useState('none'), promotionType = _p[0], setPromotionType = _p[1];
    var _q = react_1.useState(0), discountValue = _q[0], setDiscountValue = _q[1];
    ...
    function loadData() {
        return __awaiter(this, void 0, void 0, function () {
            var _a, leadsResult, productsResult, warehousesResult;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Promise.all([
                            ...
                            supabase_1.supabase.from('warehouses').select('id, name').order('name'),
                        ])];
                    case 1:
                        _a = _b.sent(), leadsResult = _a[0], productsResult = _a[1], warehousesResult = _a[2];
                        if (leadsResult.data)
    ...
    function handleSubmit(e) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var _loop_1, _i, items_1, item, state_1, totalAmount_1, orderNumber, saleData, _b, sale_1, saleError, saleItems, itemsError, error_1, totalAmount_2, orderNumber, _c, sale_2, retryError, saleItems, itemsError, retryErr_1;
                ...
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, supabase_1.supabase
                                ...
                                .single()];
                    case 2:
                        _b = _d.sent(), sale_1 = _b.data, saleError = _b.error;
                        if (saleError)
                            throw saleError;
                    ...
                    case 4:
                        error_1 = _d.sent();
                        console.error('Error creating sale:', error_1);
                        if (!(((_a = error_1.message) === null || _a === void 0 ? void 0 : _a.includes('column')) || error_1.code === '42703')) return [3 /*break*/, 10];
                        _d.label = 5;
                    case 5:
                        _d.trys.push([5, 8, , 9]);
                        ...
                        return [4 /*yield*/, supabase_1.supabase
                                ...
                                .single()];
                    case 6:
                        _c = _d.sent(), sale_2 = _c.data, retryError = _c.error;
                        if (retryError)
                            throw retryError;
                        saleItems = items.map(function (item) { return ({
                            sale_id: sale_2.id,
                    ...
                    case 8:
                        retryErr_1 = _d.sent();
                        alert('Error al crear la venta (reintento): ' + retryErr_1.message);
                        return [3 /*break*/, 9];
                    case 9: return [3 /*break*/, 11];
                    case 10:
                        alert('Error al crear la venta: ' + error_1.message);
                        _d.label = 11;
    ...
    return (React.createElement(dialog_1.Dialog, { open: open, onOpenChange: onOpenChange },
        React.createElement(dialog_1.DialogContent, { className: "max-w-3xl max-h-[90vh] overflow-y-auto" },
            React.createElement(dialog_1.DialogHeader, null,
                React.createElement(dialog_1.DialogTitle, null, "Nueva Venta"),
                React.createElement(dialog_1.DialogDescription, null, "Crea una nueva venta y descuenta autom\u00E1ticamente el inventario")),
            React.createElement("form", { onSubmit: handleSubmit, className: "space-y-6" },
                React.createElement("div", { className: "grid gap-4 sm:grid-cols-2" },
                    React.createElement("div", { className: "space-y-2" },
                        React.createElement(label_1.Label, { htmlFor: "date" }, "Fecha de venta"),
                        React.createElement(input_1.Input, { id: "date", type: "datetime-local", value: saleDate, onChange: function (e) { return setSaleDate(e.target.value); }, required: true })),
                    React.createElement("div", { className: "space-y-2" },
                        React.createElement(label_1.Label, { htmlFor: "agent" }, "Agente"),
                        React.createElement(input_1.Input, { id: "agent", value: agentName, onChange: function (e) { return setAgentName(e.target.value); }, placeholder: "Nombre del vendedor" })),
                    React.createElement("div", { className: "space-y-2" },
                        React.createElement(label_1.Label, { htmlFor: "lead" }, "Lead (opcional)"),
                        React.createElement("select", { id: "lead", value: selectedLead, onChange: function (e) { return setSelectedLead(e.target.value); }, className: "w-full rounded-md border border-slate-300 px-3 py-2 text-sm" },
                    ...
                    React.createElement("div", { className: "space-y-2" },
                        React.createElement(label_1.Label, { htmlFor: "warehouse" }, "Almac\u00E9n"),
                        React.createElement("select", { id: "warehouse", value: selectedWarehouse, onChange: function (e) { return setSelectedWarehouse(e.target.value); }, className: "w-full rounded-md border border-slate-300 px-3 py-2 text-sm" },
                            React.createElement("option", { value: "" }, "Seleccionar almac\u00E9n"),
                            warehouses.map(function (w) { return (React.createElement("option", { key: w.id, value: w.id }, w.name)); }))),
                    React.createElement("div", { className: "space-y-2" },
                        React.createElement(label_1.Label, { htmlFor: "channel" }, "Canal de venta"),
                        React.createElement("select", { id: "channel", value: channel, onChange: function (e) { return setChannel(e.target.value); }, className: "w-full rounded-md border border-slate-300 px-3 py-2 text-sm", required: true },
                    ...
                    React.createElement("div", { className: "space-y-2" },
                        React.createElement(label_1.Label, { htmlFor: "marketing" }, "Canal de marketing"),
                        React.createElement(input_1.Input, { id: "marketing", value: marketingChannel, onChange: function (e) { return setMarketingChannel(e.target.value); }, placeholder: "Ej. Facebook Ads, Influencer..." })),
                    React.createElement("div", { className: "space-y-2 sm:col-span-2" },
                        React.createElement(label_1.Label, { htmlFor: "city" }, "Ciudad de entrega"),
                        React.createElement(input_1.Input, { id: "city", value: deliveryCity, onChange: function (e) { return setDeliveryCity(e.target.value); }, placeholder: "Ciudad de destino" }))),
                ...
                React.createElement("div", { className: "space-y-4" },
                    ...
                    items.map(function (item, index) {
                        ...
                        return (React.createElement("div", { key: index, className: "grid gap-3 rounded-lg border p-4 sm:grid-cols-[1fr,100px,100px,auto]" },
                            ...
                            React.createElement("div", { className: "space-y-2" },
                                ...
                                React.createElement(input_1.Input, { type: "number", min: "1", max: (product === null || product === void 0 ? void 0 : product.stock) || 999, value: item.quantity, onChange: function (e) {
                    ...
                    items.length === 0 && (React.createElement("div", { className: "rounded-lg border border-dashed p-8 text-center text-sm text-slate-500" }, "No hay productos agregados. Haz clic en \"Agregar producto\" para comenzar."))),
                ...
                React.createElement("div", { className: "flex gap-3" },
                    ...
                    React.createElement(button_1.Button, { type: "submit", disabled: loading, className: "flex-1" }, loading ? 'Creando...' : 'Crear Venta'))))));
}
exports.CreateSaleDialog = CreateSaleDialog;
